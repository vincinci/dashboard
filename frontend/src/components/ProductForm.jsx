        ...
        <form onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="space-y-3">
                <label className="flex items-center">
                  ...
                  />
                  <span className="ml-2 text-sm text-gray-700">Offer delivery service</span>
                </label>
                ...
                <div>
                  <input
                    ...
                    placeholder="Pickup location (e.g., Downtown Kigali, Kimisagara Market)"
                  />
                  <p className="text-xs text-gray-500 mt-1">
                    Specify where customers can pick up the product
                  </p>
                </div>
              </div>
          ...
          <div className="flex items-center justify-end gap-3 p-6 border-t border-gray-200">
            ...
            <button
              type="submit"
              disabled={loading}
              className="px-6 py-2 bg-yellow-500 hover:bg-yellow-600 text-white rounded-lg disabled:opacity-50 disabled:cursor-not-allowed"
            >
